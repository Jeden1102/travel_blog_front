<template>
    <div class="relative flex justify-center items-center h-full min-h-[50vh] md:min-h-[80vh] flex-col bg-primary">
        <img class="absolute left-0 top-0 min-h-screen object-cover" src="@/assets/images/bg.jpg" />
