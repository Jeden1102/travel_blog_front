<template>
    <div
        :class="`flex flex-col-reverse min-w-72 items-center justify-between gap-6   z-10 relative ${customClass ? customClass : ''}`">
        <div class="flex flex-col gap-2 w-full  md:max-w-[332px] relative -mt-4 z-10 px-2">
